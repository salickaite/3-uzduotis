...
void testas(string name)
{
    ...
    //**********ISVEDIMAS I FAILUS**********
    Studentas::isvedimas_(vargsiukai_v_, "vargsiukai.txt");
    Studentas::isvedimas_(grupe_vec_, "kietiakai.txt");
...
void uzpildymas()
{
    ...
    if (a == 't' || a == 'T') {
        ...
        for (auto p : grupe_vec_) {
            cout << setw(20) << left << p.vardas() << setw(20) << std::fixed << std::setprecision(3) << left << p.pavarde() << setw(20) << left << std::fixed << std::setprecision(2) << p.gal_vid() << endl;
        }
    ...
    else
    {
        ...
        cout << setw(20) << left << "Vardas" << setw(20) << left << "Pavarde" << setw(20) << left << "Galutinis(Vid.)/Galutinis(Med.)" << endl;
        for (auto p : grupe_vec_) {
            cout << setw(20) << left << p.vardas() << setw(20) << left << p.pavarde() << setw(20) << std::fixed << std::setprecision(2) << left << p.gal_vid() << endl;
        }
    }
